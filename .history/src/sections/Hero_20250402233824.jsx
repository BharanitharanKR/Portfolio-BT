...
const Hero = () => {
  ...
  return (
    <section
      ...
      id="home">
      {/* Spline Embedded 3D Scene */}
      <div className="absolute inset-0 w-full h-full">
        <iframe
          src="https://my.spline.design/animatedshapeblend-e460d7b79683fb0e848e7a992e36d0b7/"
          frameBorder="0"
          width="100%"
          height="100%"
      ...
      <div className="relative w-full mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3 text-center z-10">
