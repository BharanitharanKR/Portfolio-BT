      ...
      <div className="w-full h-full absolute inset-0 flex justify-center items-center">
        <div className="relative w-full h-full">
          <iframe
            ...
            width="100%"
            height="100%"
            className="absolute inset-0 w-full h-full pointer-events-none"></iframe>
          <div className="absolute inset-0 flex justify-center items-center w-2/3 h-2/3 pointer-events-auto">
            <iframe
              src="https://my.spline.design/sandshower-cb8a6647fd0a3da81a0f6f5d12c32e47/"
              frameBorder="0"
              width="100%"
